                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs sm:text-sm text-[var(--color-text-secondary)] mb-3">
                        ...
                        <a
                          ...
                          className="font-semibold text-[#e85d26] hover:text-[#c94a1a] hover:underline"
                        >
                          PDF.co
                        </a>{" "}
                        for advanced OCR recognition, PDF to Word/Excel
                        conversion, and more powerful document processing tools.
                      </p>
                      <a
                        href="https://app.pdf.co/?via=aivaded"
                        target="_blank"
