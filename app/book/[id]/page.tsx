          ...
          <div className="md:col-span-8 flex flex-col">
            <div className="mb-6 sm:mb-8">
              ...
              <p
                ...
                suppressHydrationWarning
              >
                This publication has been indexed by our community. You can now
                process it for high-quality PDF conversion or read it directly
                using our optimized web reader.
              </p>
